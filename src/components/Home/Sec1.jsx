...
function Sec1() {
    return (
        <div className='w-full px-1 sm:px-5 bg-gradient-to-b from-[#D2CDC6] to-[#F5F5F5]'>
            ...
            <div className='w-full h-full absolute pt-45 sm:pt-80 md:pt-85 lg:pt-[350px] '>
            ...
            <img className='pt-[50px] sm:pt-[10px] sm:mx-auto' src="Headphone Image.png " alt="" />

            </div>
            <div className='w-full h-full absolute pt-30 sm:pt-50 lg:pt-[100px]'>
