...
function Compare1() {
  return (
    <div className='text-center bg-[#D2CDC6] px-3.5 sm:px-4 md:px-20 py-4 sm:py-15'>
        ...
        <div className='flex gap-[4px] sm:gap-[20px] mt-8'>
            <div className='flex flex-col bg-[#FFFFFF] gap-[20px] w-[50%] rounded-2xl p-3 md:p-5'>
                ...
                <div className='mt-[30px] py-[20px]'>
                    ...
                    <div className=' text-center'>
                        ...
                        <p className='text-[18px] text-[#666666] mt-[10px]'>2x more Active Noise Cancellation</p>
                    </div>
                    <div className=' text-center'>
                    ...
                    <div className=' text-center'>
                        ...
                        <p className='text-[18px] text-[#666666] mt-[10px]'>Up to 17 hours of listerning</p>
                    </div>
                                        <div className=' text-center'>
                        <img className='mx-auto mt-[20px]' src="Minus.png" alt="" />
                        <p className='text-[18px] text-[#666666] mt-[10px]'>None</p>
            ...
            <div className=' bg-[#FFFFFF] w-[50%] rounded-2xl p-3 md:p-5 '>
                ...
                <div className='mt-[50px] py-[20px]'>
                    ...
                    <div className=' text-center'>
                        <img className='mx-auto mt-[20px]' src="Ear.png" alt="" />
                    ...
                    <div className=' text-center'>
                        <img className='mx-auto mt-[20px]' src="BatteryCharging.png" alt="" />
                        <p className='text-[18px] text-[#666666] mt-[10px]'>Up to 6 hours of listening</p>
                    </div>
                    <div className=' text-center'>
