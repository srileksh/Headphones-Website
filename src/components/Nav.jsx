...
function Nav() {
  return (
    <div className='flex justify-between items-center px-1 sm:px-5 py-1.5 sm:py-3 bg-[#D2CDC6]'>
      {/* px-1 py-1.5 sm:px-5 sm:py-3 */}
        <div className='flex items-center'>
        <img className='w-[30px] h-[30px] sm:w-[50px] sm:h-[50px]' src="Waveform.png" alt="" />
        <h2 className='text-[#52483E] text-[15px] sm:text-2xl font-semibold'>Resonance</h2>
        </div>
        <div className='flex gap-7 sm:gap-10 md:gap-15 lg:gap-20'>
